...
/**
  ...
  El TDA Imagen proporciona además distintas herramientas para la manipulación de dichas imágenes, como son ajustes de
  contraste, ecualización del histograma, binarización de la imagen, creación de un icono a partir de una imagen o
  hacer morphing de intensidades de una imagen a otra.
